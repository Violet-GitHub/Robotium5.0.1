...
public class InstrumentationTestCase extends TestCase {
     ...
     * package hosting the activity to be launcInitialTouchModehed, which is specified in the AndroidManifest.xml
    ...
    public final <T extends Activity> T launchActivityWithIntent(
        ...
        //通过instrumentation在被测试app所在环境中，启动测试Activity，被测试的app包和测试Activity由intent传递
