...
/**
 * Robotium测试开发主入口，支持试图(Views),浏览器控件(WebViews),Activities,对话框(Dialogs),菜单(Menus),右键菜单(Context Menus);
 * 
 ...
 * <br>
 * 
 * Robotium能结合ActivityInstrumentationTestCase2和SingleLaunchActivityTestCase一起使用;
 * 
